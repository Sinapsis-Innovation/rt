...
angularRoutingApp.controller('MainCtrl', function ($scope, $http, $timeout, gridConfig, $routeParams) {
    ...
    var userInformationComplete = function (response) {
        ...
        $scope.gridOptions = {
            ...
            pdf: {
                allPages: true,
                fileName: $scope.reportTitle + " " + kendo.toString(kendo.parseDate(new Date()), 'dd/MMM/yyyy HH:MM') + ".pdf",
            ...
            excelExport: function (e) {
                exportToExcel(e, gridConfig.childColumns, $scope.reportTitle, $scope.reportType)
            },
            groupable: true,
            sortable: true,
            scrollable: true,
    ...
    function createHeader() {
        ...
        return new draw.Image("/Images/projects/reports/" + $scope.reportType + ".png", rect);
