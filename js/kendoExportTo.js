...
var exportToExcel = function(e, childCol, reporTitle, reportType) {
    ...
    if (workbook.sheets[0].rows[i].type != 'header' && workbook.sheets[0].rows[i].type != 'group-header') {
      if (reportType == 'projects') {
        ...
        for (var k = 0; k < workbook.sheets[0].rows[i].cells.length; k++) {
          if (k != (6 + RowsGroup) && k != (12 + RowsGroup) && k != (13 + RowsGroup)) workbook.sheets[0].rows[i].cells[k].hAlign = "center";
          if (k == (12 + RowsGroup) || k == (13 + RowsGroup)) {
            workbook.sheets[0].rows[i].cells[k].hAlign = "right";
          }
        }

        if (workbook.sheets[0].rows[i].cells[4 + RowsGroup].value) workbook.sheets[0].rows[i].cells[4 + RowsGroup].value = kendo.toString(new Date(workbook.sheets[0].rows[i].cells[4 + RowsGroup].value), "dd-MMM-yyyy");

        workbook.sheets[0].rows[i].cells[12 + RowsGroup].format = "_-$* #,###0";
        if (typeof workbook.sheets[0].rows[i].cells[12 + RowsGroup].value != "number") workbook.sheets[0].rows[i].cells[12 + RowsGroup].value = kendo.parseInt(workbook.sheets[0].rows[i].cells[12 + RowsGroup].value.replace("<span style='float:left;'>$</span>", ""));
        ...
        for (var k = 0; k < workbook.sheets[0].rows[i].cells.length; k++) {
          if (k != (3 + RowsGroup) && k != (8 + RowsGroup) && k != (9 + RowsGroup)) workbook.sheets[0].rows[i].cells[k].hAlign = "center";
          if (k == (8 + RowsGroup) || k == (9 + RowsGroup)) {
            workbook.sheets[0].rows[i].cells[k].hAlign = "right";
          }
        }
        //validar si hay valores nulos en los valores y asignar el cero
        workbook.sheets[0].rows[i].cells[8 + RowsGroup].value = workbook.sheets[0].rows[i].cells[8 + RowsGroup].value ? workbook.sheets[0].rows[i].cells[8 + RowsGroup].value : 0;
        ...
        //Formato moneda
        workbook.sheets[0].rows[i].cells[8 + RowsGroup].format = "_-$* #,###0";
        if (typeof workbook.sheets[0].rows[i].cells[8 + RowsGroup].value != "number") workbook.sheets[0].rows[i].cells[8 + RowsGroup].value = kendo.parseInt(workbook.sheets[0].rows[i].cells[8 + RowsGroup].value.replace("<span style='float:left;'>$</span>", ""));
        ...
        //Formato fecha
        workbook.sheets[0].rows[i].cells[10 + RowsGroup].format = workbook.sheets[0].rows[i].cells[10 + RowsGroup].value ? 'dd-MMM-yy' : '';
        ...
        for (var k = 0; k < workbook.sheets[0].rows[i].cells.length; k++) {
          if (k != (7 + RowsGroup) && k != (8 + RowsGroup)) workbook.sheets[0].rows[i].cells[k].hAlign = "center";
          if (k == (7 + RowsGroup) || k == (8 + RowsGroup)) workbook.sheets[0].rows[i].cells[k].hAlign = "right";
        }

        workbook.sheets[0].rows[i].cells[7 + RowsGroup].value = workbook.sheets[0].rows[i].cells[7 + RowsGroup].value ? workbook.sheets[0].rows[i].cells[7 + RowsGroup].value : 0;
        workbook.sheets[0].rows[i].cells[8 + RowsGroup].value = workbook.sheets[0].rows[i].cells[8 + RowsGroup].value ? workbook.sheets[0].rows[i].cells[8 + RowsGroup].value : 0;

        workbook.sheets[0].rows[i].cells[7 + RowsGroup].format = "_-$* #,###0";
        if (typeof workbook.sheets[0].rows[i].cells[7 + RowsGroup].value != "number") workbook.sheets[0].rows[i].cells[7 + RowsGroup].value = kendo.parseInt(workbook.sheets[0].rows[i].cells[7 + RowsGroup].value.replace("<span style='float:left;'>$</span>", ""));
        workbook.sheets[0].rows[i].cells[8 + RowsGroup].format = "_-$* #,###0";
        if (typeof workbook.sheets[0].rows[i].cells[8 + RowsGroup].value != "number") workbook.sheets[0].rows[i].cells[8 + RowsGroup].value = kendo.parseInt(workbook.sheets[0].rows[i].cells[8 + RowsGroup].value.replace("<span style='float:left;'>$</span>", ""));
      } else if (reportType == 'donors') {
        workbook.sheets[0].rows[i].cells[3 + RowsGroup].format = workbook.sheets[0].rows[i].cells[3 + RowsGroup].value ? 'dd-MMM-yy' : '';
      }
  ...
  workbook.sheets[0].title = reporTitle;
...
function allRows(data) {
  _.each(data, function(e) {
    if (e.field)
      ...
      _.each(e.operations, function(a) {
        allOpetarions.push(a)
      });
  });
